...
function preloadSounds() {
  ...
  Promise.all([
    loadBuffer('assets/mindmist-fishing-on-the-lake-310740.mp3'),
    loadBuffer('assets/spinopel-fishing-rod-whoosh-411640.mp3'),
    loadBuffer('assets/universfield-game-bonus-144751.mp3'),
